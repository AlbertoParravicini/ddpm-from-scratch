...
class ResBlock(nn.Module):
    ...
    def forward(
        ...
        h = h + e  # Add conditionin embedding.
...
class UNetConditioned(nn.Module):
    def __init__(
        ...
        self.timestep_embedding = nn.Embedding(num_embeddings=1024, embedding_dim=16 * 8)
        self.class_embedding = nn.Embedding(num_embeddings=num_classes + 1, embedding_dim=16 * 8)
