...
if __name__ == "__main__":
    ...
    # We can see that the embeddings are quite different,
    # and they are not ordered in any particular way.
    # This is expected, since the model is not trained to learn a particular ordering,
    # but to learn a good representation for each class.
